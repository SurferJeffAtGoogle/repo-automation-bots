 ...
 */
export async function findPullRequestForUpdatingLock(db: Db, repo: string,
  lock: OwlBotLock): Promise<string | undefined>
{
 ...
 */
export async function recordPullRequestForUpdatingLock(db: Db, repo: string,
  lock: OwlBotLock, pullRequestId: string): Promise<void>
{
  // TODO(SurferJeffAtGoogle): implement.
}

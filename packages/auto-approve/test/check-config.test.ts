...
describe('check for config', () => {
  describe('whether config is a valid YAML object', () => {
    ...
    it('should return empty if YAML is valid', async () => {
      assert(!validateYaml(
        fs.readFileSync(
  ...
  //   });
    ...
    it('should return empty if YAML has all of the possible valid options', async () => {
      assert(!await validateSchema(
        yaml.load(
          fs.readFileSync(
            './test/fixtures/config/valid-schemas/valid-schema1.yml',
            'utf8'
